document.addEventListener('DOMContentLoaded', () => {
    ...
    const scriptLines = [
        ...
        { speaker: 'A', text: '通所は「何があったから続けられた」と思いますか？' },
        ...
        { speaker: 'B', text: '仕事中でも、身につけるストレスコーピングを毎日実行するようにしています。ストレスコーピングの数を今でも増やすようにしています。' },
        ...
        { speaker: 'B', text: '元々、昔から人見知りが激しいので、訓練中に意識して行うことで少しでも改善されれば、と思っていたためです。' },
        ...
        { speaker: 'C', text: '入社したての頃は周りの環境・雰囲気に戸惑いと不安があったようにみえましたが、当初から挨拶や返事もしっかりされており、この緊張感が徐々に解消されていけばご本人の能力を十分発揮されると期待を抱きました。' },
        { speaker: 'A', text: '久しぶりのお仕事・環境変化による緊張は誰しもありますよね。今後の能力に期待されたという暖かいお言葉ありがとうございます。' },
        ...
        { speaker: 'C', text: '品質保証部検査グループは弊社において最終工程に位置づけられます。前工程の遅れが生じた場合、検査グループ内で遅れを挽回させなければなりません。' },
        ...
        { speaker: 'A', text: '9カ月経過した現在の表情ややりとりに変化は感じられましたか？' },
        ...
        { speaker: 'A', text: 'ちなみに、作業で気をつけていることはありますか？' },
        ...
        { speaker: 'C', text: 'また、毎朝の職場ミーティングでは表情を確認し体調に変化がないか気をつけています。' },
        ...
        { speaker: 'A', text: '最後に杉山さまから、卒業生の櫻本さんへメッセージをお願いします。' },
